document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderLoop() {
        ...
        if (scrolled !== lastRenderedScrollY && mainLogo && !document.body.classList.contains('page-inner')) {
            ...
            // Rimosso l'easing per evitare conflitti con l'inerzia nativa dello scroll (causa dello "scatto")
            ...
            // Disattiva il text-shadow su mobile perché causa cali di framerate severi (scatti)
            if (window.innerWidth > 768) {
